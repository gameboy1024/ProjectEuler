 ...
 * Answer:
 * 70600674
 * Completed on Sun, 24 Nov 2013, 23:49
...
public class Problem11 {
	...
	public static void main(String[] args) {
		int[][] matrix = new int[][] {
				{ 8, 2, 22, 97, 38, 15, 00, 40, 00, 75, 4, 5, 7, 78, 52, 12,
						50, 77, 91, 8 },
				...
				{ 78, 17, 53, 28, 22, 75, 31, 67, 15, 94, 3, 80, 4, 62, 16, 14,
						9, 53, 56, 92 },
				{ 16, 39, 5, 42, 96, 35, 31, 47, 55, 58, 88, 24, 00, 17, 54,
						24, 36, 29, 85, 57 },
				{ 86, 56, 00, 48, 35, 71, 89, 7, 5, 44, 44, 37, 44, 60, 21, 58,
						51, 54, 17, 58 },
		...
		int max = 0, tmp, posI = 0, posJ = 0, type = 0;
		// Horizontal
		for (int i = 0; i < 20; i++) {
			for (int j = 0; j < 17; j++) {
		...
		for (int i = 0; i < 17; i++) {
			for (int j = 0; j < 17 - i; j++) {
				tmp = matrix[j][j + i] * matrix[j + 1][j + i + 1]
						* matrix[j + 2][j + i + 2] * matrix[j + 3][j + i + 3];
				if (tmp > max) {
					max = tmp;
					posI = i;
					posJ = j;
				...
				tmp = matrix[i + j][j] * matrix[i + j + 1][j + 1]
						* matrix[i + j + 2][j + 2] * matrix[i + j + 3][j + 3];
				if (tmp > max) {
					max = tmp;
					posI = i;
					posJ = j;
		...
		for (int i = 19; i > 2; i--) {
			for (int j = 0; j < i - 2; j++) {
				tmp = matrix[j][i - j] * matrix[j + 1][i - j - 1]
						* matrix[j + 2][i - j - 2] * matrix[j + 3][i - j - 3];
				if (tmp > max) {
					max = tmp;
					posI = i;
					posJ = j;
		...
		System.out.println("i : " + posI + "  j : " + posJ + "  type : " + type);
	}
}
